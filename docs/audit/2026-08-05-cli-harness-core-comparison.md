...
1. Accept 6A on hosted Windows/macOS/Ubuntu and controlled VS Code, then add the
   6B interaction transcript so only proven-idempotent boundaries can resume and
   ambiguous non-idempotent work remains blocked.
