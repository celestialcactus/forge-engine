...
**Date:** 2026-07-27
**Status:** Integration transition in progress; post-merge hosted gate pending
...
The transition PR adds `develop` to the hybrid push filter and updates only branch
policy documentation. Its resulting merge commit must pass both hosted workflows
