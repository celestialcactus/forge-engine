# Archived Forge Engine v0.1 prototype

> **Historical reference only.** This implementation and the claims below are not
> the current ForgeEngine architecture, product surface, installation guide, or
> security posture. The V1 authority is
> `docs/architecture/forgeengine-v1-validated-build-plan.md`.

## Original prototype README
